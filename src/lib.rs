...
#[derive(Debug)]
pub struct MetaPhotonProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MetaPhotonProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MetaPhoton processing");
    
    let mut processor = MetaPhotonProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MetaPhotonProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MetaPhotonProcessor::new(false);
